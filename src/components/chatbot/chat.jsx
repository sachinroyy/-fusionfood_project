...
//       {/* Glowing Text */}
//       <p className="absolute -left-40 top-1/2 -translate-y-1/2 text-black text-lg font-semibold glow-animation ">
//         Hey, Sara this side <br /> 
//       </p>
//       {/* Circular Button */}
//       <button
//         onClick={toggleChat}
//         className="w-16 h-16 rounded-full text-black p-[1px] font-sans font-semibold flex items-center justify-center shadow-lg bg-black "
//       >
//        <video
//   ref={videoRef}
//   className="rounded-[50%] w-full h-fu  ll object-cover  hover:scale-110 cursor-pointer "
//   src={botmp4}
//   loop
//   autoPlay
//   muted
