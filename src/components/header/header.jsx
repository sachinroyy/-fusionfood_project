...
//           <img src={Logo} alt="Company Logo" className="h-[100px] w-[300px] mr-2" />
//           </Link>

//         </div>

//         {/* Navigation Buttons */}
//         <div className="flex space-x-4 gap-10 text-2xl ">
  ...
  return (
    <header className="shadow-md">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex space-x-4 gap-10 text-2xl">
          <Link to="/" className="hover:text-gray-300 hover:underline">
            Home
          </Link>
          <Link to="/menu" className="hover:text-gray-300 hover:underline">
